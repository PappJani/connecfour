...
public class NyeresiFeltetelTest {
  ...
  @Test
  public void testVizszintesGyozelem() {
    char[][] tabla = {
        {'X', 'X', 'X', 'X', ' ', ' ', ' '},
        {' ', ' ', ' ', ' ', ' ', ' ', ' '},
        {' ', ' ', ' ', ' ', ' ', ' ', ' '},
  ...
  @Test
  public void testFuggolegesGyozelem() {
    char[][] tabla = {
        {' ', ' ', ' ', ' ', ' ', ' ', ' '},
        {' ', ' ', ' ', ' ', ' ', ' ', ' '},
        {'X', ' ', ' ', ' ', ' ', ' ', ' '},
  ...
  @Test
  public void testAtlosBalrolJobbraGyozelem() {
    char[][] tabla = {
        {' ', ' ', ' ', ' ', ' ', ' ', ' '},
        {' ', ' ', ' ', ' ', ' ', ' ', ' '},
        {' ', ' ', 'X', ' ', ' ', ' ', ' '},
  ...
  @Test
  public void testAtlosJobbrolBalraGyozelem() {
    char[][] tabla = {
        {' ', ' ', ' ', ' ', ' ', ' ', ' '},
        {' ', ' ', ' ', ' ', ' ', ' ', ' '},
        {' ', ' ', ' ', 'X', ' ', ' ', ' '},
