...
/**
 * Class that represents the winning condition for the Connect 4 game.
 */
public class NyeresiFeltetel {
   ...
   *
   * @param tabla   A játék tábla.
   * @param jatekos A játékos karaktere.
   * @return Igaz, ha a győzelmi feltétel teljesül.
   */
